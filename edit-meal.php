...
if ($meal_id > 0) {
    // Fetch meal details from the database using MySQLi
...
<body>
    <h1>Edit Meal</h1>
    <form action="update-meal.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?= htmlspecialchars($meal['id']) ?>">
        <label for="meal_name">Meal Name:</label>
        <input type="text" name="meal_name" id="meal_name" value="<?= htmlspecialchars($meal['meal_name']) ?>" required>
